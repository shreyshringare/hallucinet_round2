...
"""
FastAPI application for the Hallucinet Adversarial Environment.

This module creates an HTTP server that exposes the HallucinetAdversarialEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m hallucinet_adversarial.server.app
    ...
    multiple workers:
        uvicorn hallucinet_adversarial.server.app:app --workers 4
    """
    import uvicorn
